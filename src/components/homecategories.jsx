...
function Category() {
  return (
    <div className="text-center relative flex flex-col justify-center items-center">
      <div className="bg-slate-200  w-[80px] aspect-square sm:w-[100px] lg:w-[120px] mb-[10px] rounded-lg flex flex-row justify-center items-center">
      ...
      <p className="bottom-0  text-black font-bold text-sm sm:text-base md:text-lg lg:text-xl">Starters</p>
    </div>
  );
}
