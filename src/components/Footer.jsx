...
const Footer = () => {
  return (
    <footer
      id="footer"
      className="relative bottom-0 flex justify-between items-center text-white h-60 "
    >
      <div
      ...
      <div className="z-10 mb-36 ml-8 font-semibold sm:text-3xl md:text-3xl lg:text-4xl">
        <img
          src={Logo}
          alt="Logo"
          className="pt-8 lg:pt-24 pl-4 w-28 lg:w-32 "
        />
        <img
          src={LogoName}
          alt="LogoName"
          className="w-24 lg:w-32 pl-8 lg:pl-4 "
        />
      </div>
      ...
      <div className="flex flex-col absolute inset-x-0 top-32 text-center items-center justify-center">
        <h2 className="sm:text-1xl font-semibold">
